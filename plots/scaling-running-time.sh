...
s=athena;            $SOURCE_DIR/scaling-running-time.py -s $s          -i $SOURCE_DIR/common.json -o $SOURCE_DIR/scaling-running-time-$s.pdf
...
s=postgres;          $SOURCE_DIR/scaling-running-time.py -s $s -l       -i $SOURCE_DIR/common.json -o $SOURCE_DIR/scaling-running-time-$s.pdf
